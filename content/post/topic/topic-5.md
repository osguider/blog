...
{{< shields path="github/stars/iluwatar/java-design-patterns" alt="Github Repo Stars" >}} {{< shields path="github/license/iluwatar/java-design-patterns" alt="License: `NOASSERTION`" >}} {{< shields path="github/languages/top/iluwatar/java-design-patterns" alt="Language: `Unknown`" >}}

{{< github-opengraph user="iluwatar" repo="java-design-patterns" alt="cover" >}}
...
{{< shields path="github/stars/Developer-Y/cs-video-courses" alt="Github Repo Stars" >}} {{< shields path="github/license/Developer-Y/cs-video-courses" alt="License: `NOASSERTION`" >}} {{< shields path="github/languages/top/Developer-Y/cs-video-courses" alt="Language: `Unknown`" >}}

{{< github-opengraph user="Developer-Y" repo="cs-video-courses" alt="cover" >}}
